...
hi MyTagListFileName          guifg=#BD9700    guibg=NONE        guisp=NONE         gui=none
...
hi TabLine                    guifg=#8a3824    guibg=NONE        guisp=NONE         gui=none
hi TabLineSel                 guifg=#9A7B00    guibg=#492224     guisp=NONE         gui=none
hi TabLineFill                guifg=#3D3D3D    guibg=NONE        guisp=NONE         gui=none
...
hi PMenu                      guifg=#5a5a5a    guibg=#141414     guisp=#1a1a1a      gui=none
hi PMenuSbar                  guifg=NONE       guibg=#848688     guisp=#848688      gui=none
hi PMenuSel                   guifg=NONE       guibg=#750000     guisp=#BD9800      gui=bold
...
hi SpellBad                   guifg=#F9F9FF    guibg=#192224     guisp=#192224      gui=none
hi SpellCap                   guifg=#F9F9FF    guibg=#192224     guisp=#192224      gui=none
hi SpellLocal                 guifg=#F9F9FF    guibg=#192224     guisp=#192224      gui=none
hi SpellRare                  guifg=#F9F9FF    guibg=#192224     guisp=#192224      gui=none
...
hi VisualNOS                  guifg=#192224    guibg=#750000     guisp=#F9F9FF      gui=none
hi WarningMsg                 guifg=#A1A6A8    guibg=#912C00     guisp=#912C00      gui=NONE
hi WildMenu                   guifg=#BD9800    guibg=NONE        guisp=NONE         gui=NONE

" HTML syntax {
hi HtmlHiLink                 guifg=NONE        guibg=#492224     guisp=NONE         gui=none
hi htmlLinkText               guifg=NONE        guibg=#492224     guisp=NONE         gui=none
...
" PHP/ Mysql syntax {
hi PHPprivate                 guifg=#978A55    guibg=NONE        guisp=NONE         gui=bold
hi PHPfunction                guifg=#978A55    guibg=NONE        guisp=NONE         gui=bold
hi PHPtest                    guifg=#978A55    guibg=NONE        guisp=NONE         gui=bold
hi PHPClass                   guifg=#978A55    guibg=NONE        guisp=NONE         gui=bold
hi PHPConstant                guifg=#978A55    guibg=NONE        guisp=NONE         gui=bold
...
" Python syntax {
hi pythonFunction             guifg=#8A905D    guibg=NONE        guisp=NONE         gui=none
...
hi jsFunction                 guifg=#648A1C    guibg=NONE        guisp=NONE         gui=bold
hi javascriptFunction         guifg=#648A1C    guibg=NONE        guisp=NONE         gui=bold
...
hi jsFuncName                 guifg=#648A1C    guibg=NONE        guisp=NONE         gui=none
hi javascriptFuncName         guifg=#648A1C    guibg=NONE        guisp=NONE         gui=none
