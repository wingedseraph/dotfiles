local M = {}
local g = vim.g
local config = require("misc.base46.nvconfig")
...
M.get_theme_tb = function(type)
	local default_path = "misc.base46.themes." .. config.ui.theme
...
local change_hex_lightness = require("misc.base46.colors").change_hex_lightness
...
M.extend_default_hl = function(highlights, integration_name)
	...
	if config.ui.transparency then
		local glassy = require("misc.base46.glassy")
...
M.load_integrationTB = function(name)
	local highlights = require("misc.base46.integrations." .. name)
