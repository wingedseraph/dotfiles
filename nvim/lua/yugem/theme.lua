...
function M.get(config)
   ...
   theme = {
      ...
      Comment = { fg = p.color500, style = "italic" },
      ...
      ['@comment.lua'] = { fg = p.color500, style = "italic" },
      ...
      ['@tag.attribute'] = { fg = p.color300, style = 'italic' },
      ['@text'] = { fg = p.color200 },
   ...
   vim.cmd.hi('link IndentBlanklineContextStart Folded')
   -- vim.cmd.hi('link StatusLine Folded')
   vim.cmd.hi('clear StatusLine')
   -- vim.cmd.hi('StatusLineNC guifg=NvimLightGrey4')
   vim.cmd.hi('Tabline guibg=black')
   vim.cmd.hi('clear Comment')
   vim.cmd.hi('link Comment Italic')
   vim.cmd.hi('MiniTablineHidden guifg=#696969')
