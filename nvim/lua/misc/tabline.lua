...
H.create_default_hl = function()
   ...
   set_default_hl('MiniTablineModifiedCurrent', { link = 'TabLineSel' })
...
H.is_buffer_in_minitabline = function(buf_id)
...
H.make_unnamed_label = function(buf_id)
   ...
   -- Possibly add tracking id NOTE dont need to me
...
H.get_nonunique_tab_ids = function()
   ...
   return H.tbl_flatten(vim.tbl_filter(function(x)
      return #x > 1
   end, label_tab_ids))
end
