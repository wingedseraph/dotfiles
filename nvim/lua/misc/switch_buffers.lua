...
vim.keymap.set(
   {'n','t'},
   "<M-1>",
   "<cmd>lua open_buffer_by_number(1)<cr>",
   { silent = true }
)
vim.keymap.set(
   {'n','t'},
   "<M-2>",
   "<cmd>lua open_buffer_by_number(2)<cr>",
   { silent = true }
)
vim.keymap.set(
   {'n','t'},
   "<M-3>",
   "<cmd>lua open_buffer_by_number(3)<cr>",
   { silent = true }
)
vim.keymap.set(
   {'n','t'},
   "<M-4>",
   "<cmd>lua open_buffer_by_number(4)<cr>",
   { silent = true }
)
vim.keymap.set(
   {'n','t'},
   "<M-5>",
   "<cmd>lua open_buffer_by_number(5)<cr>",
   { silent = true }
)
vim.keymap.set(
   {'n','t'},
   "<M-6>",
   "<cmd>lua open_buffer_by_number(6)<cr>",
   { silent = true }
)
vim.keymap.set(
   {'n','t'},
   "<M-7>",
   "<cmd>lua open_buffer_by_number(7)<cr>",
   { silent = true }
)
vim.keymap.set(
   {'n','t'},
   "<M-8>",
   "<cmd>lua open_buffer_by_number(8)<cr>",
   { silent = true }
)
vim.keymap.set(
   {'n','t'},
   "<M-9>",
   "<cmd>lua open_buffer_by_number(9)<cr>",
   { silent = true }
)
