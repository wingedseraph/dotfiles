...
vscode.load = function(style)
   ...
   -- vim.cmd.hi('StatusLineNC guibg=#1f1f1f guifg=#1f1f1f')
   vim.cmd.hi('CmpItemKind guibg=none')
   vim.cmd.hi('link MiniTablineModifiedHidden DiffAdd')
   vim.cmd.hi('clear MiniTablineHidden')
   -- vim.cmd.hi('MiniTablineHidden guibg=none')
   vim.cmd.hi('link MiniTablineHidden Normal')
