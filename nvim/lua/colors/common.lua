...
function M.highlights(p)
    ...
    return {
        ...
        ["@markup.list.unchecked.markdown"]       = { link = "DiffDelete"    },
        ["@markup.list.checked.markdown"]       = { link = "DiffAdd"    },
