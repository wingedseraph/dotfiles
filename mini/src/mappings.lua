...
vim.api.nvim_set_keymap("n", "<Tab>", "<cmd>bnext<cr>", { noremap = true, silent = true, desc = "next buffer" })
vim.api.nvim_set_keymap("n", "<S-Tab>", "<cmd>bprevious<cr>", { noremap = true, silent = true, desc = "prev buffer" })
vim.api.nvim_set_keymap("n", "<Esc>", "<cmd>nohl<cr>", { noremap = true, silent = true, desc = "clear highlighting" })
vim.api.nvim_set_keymap("n", "<M-n>", "<cmd>Yazi<cr>", { noremap = true, silent = true, desc = "yazi file manager" })
vim.keymap.set("n", "<leader>q", vim.diagnostic.setloclist, { desc = "Open diagnostics list" })
vim.keymap.set("n", "sj", "<C-w>w", { noremap = true, silent = true, desc = "yazi file manager" })
vim.keymap.set("n", ";", ":", { noremap = true, silent = true, desc = ": ;" })
vim.keymap.set({ "n", "v" }, "1", "$", { noremap = true, silent = true, desc = "1 $" })
